...
func TestNewMonitorable(t *testing.T) {
	...
	// init Env
	// OK
	_ = os.Setenv("MO_MONITORABLE_GITLAB_VARIANT0_TOKEN", "xxx")
	// Missing Token
	_ = os.Setenv("MO_MONITORABLE_GITLAB_VARIANT1_URL", "https://gitlab.example.com/")
	// Url broken
	_ = os.Setenv("MO_MONITORABLE_GITLAB_VARIANT2_URL", "url%sgitlab.example.com/")
